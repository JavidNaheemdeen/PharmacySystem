                         ...
                         <Navbar.Collapse id="navbar-dark-example">
                              <div className="navbar-collapse row m-auto ">
                                   <div className="navbar-nav col-md-10">
                                        <a href="/Admindashboard" className="nav-item nav-link dash-link active bg-secondary"><FaHome/> Admin Dashboard </a>
                                        <a href="/Productdashboard" className="nav-item nav-link dash-link"><MdInventory2 /> Product Dashboard </a>
